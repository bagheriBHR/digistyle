...
@section('content')
    ...
    <div class="col-md-10 pb-3 px-0">
        <div class="mb-4">
            ...
            <form class="customform p-3 bg-white" method="post" action="{{route('attributeValue.store')}}">
                @method('POST')
                @csrf
                ...
                <div class="form-group row d-flex align-items-center">
                    <label for="type" class="custom-field-title col-sm-2 col-form-label text-right font-weight-bold mr-2">نام گروه :</label>
                    <div class="col-sm-5">
