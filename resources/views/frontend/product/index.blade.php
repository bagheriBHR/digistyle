...
@section('content')
    ...
    <!-- end of right side -->
        ...
        <div class="col-10 d-flex flex-column pl-0">
            ...
            @endif
            <div class="stuff d-flex flex-column flex-md-row py-3 border-stuff mb-5 bg-white">
                <div class="col-12 col-md-6 d-flex border-left p-0">
                        <div class="icon mr-2 d-flex flex-row flex-md-column justify-content-center">
                            ...
                            <a><img src="/frontend/img/stuff/icons8-compare-2.png" alt=href=" class=" mb-3" title="مقایسه"></a>
                        </div>
